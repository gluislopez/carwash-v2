            ...
            <div className="dashboard-header" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '0.8rem', color: 'white', backgroundColor: '#F472B6', border: '1px solid white', padding: '0.2rem 0.5rem', borderRadius: '4px', boxShadow: '0 0 10px #F472B6' }}>
                            v4.127 GLOBAL SYNC 6 {new Date().toLocaleTimeString()}
                        </span>
                    </div>
