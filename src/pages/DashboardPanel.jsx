    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.875rem', marginBottom: '0.5rem' }}>Dashboard <span style={{ fontSize: '1rem', color: 'black', backgroundColor: '#06b6d4', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>v3.83 RECONNECT SUCCESS {new Date().toLocaleTimeString()}</span></h1>
