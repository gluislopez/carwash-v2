...
import { Plus, Car, DollarSign, Users, Trash2, Edit2, Clock, RefreshCw } from 'lucide-react';
...
const Dashboard = () => {
    ...
    *,
    ...
    const { data: transactionsData, create: createTransaction, update: updateTransaction, remove: removeTransaction, refresh: refreshTransactions } = useSupabase('transactions', `*, customers(name, vehicle_plate, vehicle_model), transaction_assignments(employee_id)`, { orderBy: { column: 'date', ascending: false } });
    ...
    return (
        <div>
                ...
                <div>
                    <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '0.8rem', color: 'white', backgroundColor: '#F59E0B', border: '1px solid white', padding: '0.2rem 0.5rem', borderRadius: '4px', boxShadow: '0 0 10px #F59E0B' }}>
                            v4.87 ADMIN CHART {new Date().toLocaleTimeString()}
                        </span>
                    </div>
            ...
            {userRole === 'admin' ? (
                <EmployeeProductivityChart transactions={statsTransactions} employees={employees} />
            ) : (
                <ProductivityBar
