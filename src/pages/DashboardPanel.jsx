    ...
    return (
        <div>
            <div className="dashboard-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.875rem', marginBottom: '0.5rem' }}>Dashboard <span style={{ fontSize: '1rem', color: 'white', backgroundColor: '#000000', border: '1px solid white', padding: '0.2rem 0.5rem', borderRadius: '4px' }}>v4.00 MOBILE READY {new Date().toLocaleTimeString()}</span></h1>
