                            ...
                            <div style={{ backgroundColor: 'rgba(255,255,255,0.02)', padding: '20px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                ...
                                {isAddingCustomer && (
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                                        <input type="text" style={{ gridColumn: 'span 2', height: '40px', backgroundColor: 'black', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', padding: '0 12px', color: 'white', fontSize: '13px' }} placeholder="Nombre completo" value={newCustomer.name} onChange={e => setNewCustomer({...newCustomer, name: e.target.value})} />
                                        <input type="text" style={{ height: '40px', backgroundColor: 'black', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', padding: '0 12px', color: 'white', fontSize: '13px' }} placeholder="Teléfono (Obligatorio para alertas)" value={newCustomer.phone || ''} onChange={e => setNewCustomer({...newCustomer, phone: e.target.value})} />
